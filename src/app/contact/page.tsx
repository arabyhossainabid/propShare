...
const contactInfo = [
    ...
    },
    {
        icon: Mail,
        title: "Email Us",
        details: ["hello@propshare.com", "support@propshare.com", "invest@propshare.com"],
        color: "purple",
    },
    {
        icon: Clock,
            ...
            <div className="container-custom">
                ...
                <div className="page-header text-center space-y-4 mb-16">
                    ...
                    <p className="text-white/40 text-lg max-w-2xl mx-auto">
                        Have questions about investing with PropShare? Our team of
                        experts is here to help you make informed decisions.
                    </p>
                </div>
                ...
                <div className="grid md:grid-cols-3 gap-4 mb-20">
                    {quickActions.map((action) => {
                        ...
                        return (
                            <div key={action.title} className="quick-action group cursor-pointer">
