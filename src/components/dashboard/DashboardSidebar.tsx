...
const sidebarLinks = [
    ...
    { name: "Create Property", href: "/dashboard/properties/create", icon: PlusCircle },
        ...
        <aside className="w-64 shrink-0 hidden lg:block">
            <div className="sticky top-28 space-y-2">
                ...
                <div className="border-t border-white/5 pt-4 mt-4 space-y-1">
                    <button className="flex items-center gap-3 px-4 py-3 rounded-xl text-sm text-white/40 hover:text-white hover:bg-white/5 transition-all w-full">
